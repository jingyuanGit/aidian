...
function createViewHarness(options: {
  ...
  const view = Object.create(AidianView.prototype) as any;
...
describe('AidianView tab controls', () => {
  it('hides the new-tab button when the tab manager is at capacity', () => {
    ...
    expect(newTabButtonEl.hasClass('aidian-hidden')).toBe(true);
