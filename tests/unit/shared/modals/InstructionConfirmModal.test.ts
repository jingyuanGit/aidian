...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'aidian-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'aidian-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'aidian-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.hasClass('aidian-hidden')).toBe(false);

      const clarificationEl = findByClass(contentEl, 'aidian-instruction-clarification-section');
      expect(clarificationEl.hasClass('aidian-hidden')).toBe(true);

      const confirmationEl = findByClass(contentEl, 'aidian-instruction-confirmation-section');
      expect(confirmationEl.hasClass('aidian-hidden')).toBe(true);
    });
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'aidian-instruction-btn');
  ...
  describe('showClarification', () => {
    it('transitions to clarification state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'aidian-instruction-loading');
      expect(loadingEl.hasClass('aidian-hidden')).toBe(true);

      const clarificationEl = findByClass(contentEl, 'aidian-instruction-clarification-section');
      expect(clarificationEl.hasClass('aidian-hidden')).toBe(false);
    });
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'aidian-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    it('transitions to confirmation state', () => {
      ...
      const confirmationEl = findByClass(contentEl, 'aidian-instruction-confirmation-section');
      expect(confirmationEl.hasClass('aidian-hidden')).toBe(false);
    });
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'aidian-instruction-refined');
