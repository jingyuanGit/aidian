...
describe('AidianService', () => {
  let mockPlugin: Partial<AidianPlugin>;
  let mockMcpManager: MockMcpServerManager;
  let service: AidianService;
  ...
  beforeEach(() => {
    ...
    service = new AidianService(mockPlugin as AidianPlugin, mockMcpManager);
  });
